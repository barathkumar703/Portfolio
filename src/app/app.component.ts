  ...
  servicesList = [
    {
      ...
      description:
        'Specializing in developing clean, maintainable, and scalable UI components using frameworks such as Angular and React. Skilled in implementing responsive designs and integrating APIs.'
    },
    {
      subtitle: 'Asst.Cinematography',
      title: 'Asst Cinematography',
      description:
        'As an Assistant Cinematographer, I support the Director of Photography (DOP) in bringing the visual narrative through technical precision, creative collaboration and hands-on camera support. My role spans across on-set execution, and ensuring a smooth workflow and high-quality visuals.'
    },
    {
      subtitle: 'Photos & Graphic Designing',
      title: 'Adobe Photoshop',
      description:
        'Powerful features to edit photos, create artwork, design UI/UX, make GIFs, and create 3D content.'
    },
    {
      subtitle: 'Video Editing',
      title: 'Adobe Premiere Pro',
      description:
        'Proficient in Adobe Premiere Pro for cutting, color grading, audio syncing, and transitions to produce polished video content.'
    }
  ];
  ...
  experienceList = [
    {
      ...
      date: '2023 - Present',
      description: 'Worked as Frontend Developer for real-time project. Specializing in developing clean, maintainable, and scalable UI components using HTML, CSS, JavaScript and Angular Framework. Skilled in implementing responsive designs and integrating APIs.'
    },
    {
